...
export const metadata: Metadata = {
  title: 'Real Estate Investment in Buenos Aires | Latin American Capital | HAYTEM SOVEREIGN',
  description:
    'Private intelligence on Buenos Aires real estate investment, Latin American capital positioning, and Southern Cone development for strategic capital allocators. Off-market opportunities in Argentina\'s premier metropolitan destination.',
  keywords: [
    'Buenos Aires real estate investment',
    'Latin American capital',
    'Southern Cone development',
    'Argentina luxury real estate',
    'off-market real estate Buenos Aires',
    'strategic real estate investment Buenos Aires',
    'capital deployment opportunities Buenos Aires',
    'institutional property investment Argentina',
    'luxury real estate Argentina',
    'Argentina real estate investment',
    'Latin America real estate',
    'where to invest in real estate in Buenos Aires',
    'is Buenos Aires a good real estate investment',
    'best property investment opportunities in Buenos Aires',
  ],
};

const assetClasses = [
  {
    title: 'Puerto Madero Developments',
    description:
  ...
  {
    title: 'Recoleta Estate Compounds',
    description:
      ...
      <div className="sovereign-container" style={{ maxWidth: '980px', margin: '0 auto' }}>
        <div style={{ marginBottom: '3rem' }}>
          ...
          >
            Buenos Aires
            <br />
            Latin American capital intelligence for Southern Cone development.
          </h1>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '1rem' }}>
          <Link
            href="/mandate?city=buenos-aires"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
          ...
          >
            Request private access to our confidential Buenos Aires real estate intelligence and strategic positioning opportunities.
          </p>
        </div>
      </div>
    </section>
